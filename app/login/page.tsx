...
import { AlertCircle, Calculator, Lock, User } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight">PajakKu</h1>
          <p className="text-muted-foreground mt-2">Platform Pajak Indonesia</p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-8">
          © 2026 PajakKu. All rights reserved.
        </p>
      </div>
    </div>
  );
