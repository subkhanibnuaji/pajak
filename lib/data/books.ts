...
export const LIBRARY_CONFIG = {
  ...
  pageTitle: 'Tax Book Library',

  /** Deskripsi singkat di hero section */
  pageDescription:
    'Curated collection of essential Tax books with summaries and downloadable eBooks.',
  ...
  /** Empty state message */
  emptyStateMessage: 'No tax books found matching your criteria.',
} as const;
